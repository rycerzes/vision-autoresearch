...
def build_worker_contract(state: dict) -> str:
    ...
    lines = [
        ...
        "Allowed edit scope:",
        f"- edit `{config}` only",
        "- never edit training scripts (`train_ultralytics.py`, `train_hf_vision.py`)",
        "- do not edit `prepare.py` or other orchestration as part of the hypothesis — configs only",
